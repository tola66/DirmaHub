...
task.spawn(function()
        ...
        if SharedState.ListNeedsRedraw then
            ...
            if allPets and #allPets > 0 then
                for i = 1, #allPets do
                    ...
                    local MUT_COLORS_UI = {
                        Cursed=Color3.fromRGB(200,0,0), Gold=Color3.fromRGB(138, 43, 226),
    ...
    local function ShowPriorityAlert(brainrotName, genText, mutation, ownerUsername)
        ...
        local mutationColors = {
            ...
            ["gold"] = Color3.fromRGB(138, 43, 226),
...
task.spawn(function()
    local function checkText(obj)
        ...
        if string.find(obj.Text or "", "You stole") then
            kickPlayer()
        end
    end
...
task.spawn(function()
    ...
    if privateBuild then
        ...
        author.Text = "https://discord.gg/b7NMFqJZBP "
    end
